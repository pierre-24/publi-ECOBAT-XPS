...
\begin{figure}[!h]
	...
	\caption{Effect of slab thickness (expressed as the number of layers, $N/N_0$, where $N_0 = 2$ for Ca and CaO and 4 for \ce{CaH2} represents the number of layers in the unit cell)  on the mean bulk (filled markers) and surface (empty markers) \dbe{} for Ca 2s, calculated using the SJ\textsuperscript{n} protocol with various reference energies. The vertical lines indicate standard deviation.}
