...
\begin{figure}[!h]
	...
	\caption{Effect of slab thickness (expressed as the number of layers, $N/N_0$, where $N_0$ represents the number of layers in the unit cell) on the bulk (filled markers) and surface (empty markers) \dbe{} for Ca 2s, calculated using the SJ protocol with various reference energies.}
...
\begin{figure}[!h]
	...
	\caption{Effect of slab thickness (expressed as the number of layers, $N/N_0$, where $N_0$ represents the number of layers in the unit cell) on the bulk (filled markers) and surface (empty markers) \dbe{} for Ca 2s, calculated using the SJ\textsuperscript{n} protocol with various reference energies.}
