...
\begin{figure}[!h]
	...
	\caption{XPS spectra (as computed with the SJ protocol, using $\sigma=\SI{0.6}{\electronvolt}$) of the adsosorbates \textbf{h} and \textbf{j} on Ca, CaO and \ce{CaO.H2O}.}
	\label{fig:poss}
\end{figure}
