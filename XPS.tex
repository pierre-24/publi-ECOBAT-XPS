...
\begin{figure}[!h]
	\centering
	 ...
	 \caption{Comparison between experimental and calculated gas phase \dbe{}, as computed with the SJ (left) and SJ\textsuperscript{n} (right) protocols, using different references, on the carbon atom (N=107). For each reference, the error (as mean $\pm$ standard deviation) is given.}
