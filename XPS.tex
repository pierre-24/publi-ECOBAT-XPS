...
\added{More broadly, this study demonstrates that the prediction of spectroscopic data, particularly XPS binding energies, through computational quantum chemistry methods can yield valuable insights for experimental investigations, especially by highlighting the roles of specific atoms and the reactions in which they are involved.} \cite{ebadiInsightsLiMetalOrganic2019}\added{  Furthermore, these simulations enable the exploration of reactive intermediates, as illustrated in this work. Finally, they facilitate the disentanglement of surface and bulk contributions, a task that remains experimentally challenging.}
