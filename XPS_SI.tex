...
\begin{table}
	...
	CaO & 0.31 $\pm$ 0.04 & 0.82 $\pm$ 0.00 &  & -2.99 $\pm$ 0.01 & -3.63 $\pm$ 0.00 \\
		...
		\bottomrule
		\end{tabular}
		    \caption{Mean (and standard deviation) bulk and surface \dbe{} values for 6-layer (\ce{Ca^0}, CaO, and \ce{CaO.H2O}) and 12-layer (\ce{CaH2}) slabs, computed using the SJ protocol with various reference energies.}
\end{table}
...
\begin{table}
	\begin{tabular}{l cc c cc}
		...
		\bottomrule
	\end{tabular}
	\caption{Mean (and standard deviation) bulk and surface \dbe{} values for 6-layer (\ce{Ca^0}, CaO, and \ce{CaO.H2O}) and 12-layer (\ce{CaH2}) slabs, computed using the SJ\textsuperscript{n} protocol with various reference energies.}
\end{table}
