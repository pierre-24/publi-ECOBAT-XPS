...
\begin{figure}[!h]
	...
	\caption{Convergence of the absolute binding energy with the PW cutoff energy for an isolated methanol molecule (\texttt{ENCUT}, in \si{\electronvolt}, top) and with the size of the $\Gamma$-centered k-point mesh grid for a Ca (100) 1x1 slab with 6 layers (bottom). For the other calculation parameters, see main text.}
	\label{fig:conv}
\end{figure}
